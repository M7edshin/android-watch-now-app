...
import static m7edshin.popularmovieapp.Utilities.Constants.QUERY_SORTING_AVERAGE;
import static m7edshin.popularmovieapp.Utilities.Constants.QUERY_VOTE_AVERAGE;
...
import static m7edshin.popularmovieapp.Utilities.Constants.VOTE_AVERAGE_FROM_PAR_KEY;
import static m7edshin.popularmovieapp.Utilities.Constants.YEARS;
...
public class TopRatedMoviesFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<MovieDetails>> {
    ...
    public Loader<List<MovieDetails>> onCreateLoader(int id, Bundle args) {
        String releaseDateFrom = getLastTenYears();
        String releaseDateTo = getCurrentYear();
        String query = createUrlRequest(releaseDateFrom, releaseDateTo);
    ...
    private String createUrlRequest(String strReleaseDateFrom, String strReleaseDateTo) {
        ...
        builder.appendQueryParameter(API_PAR_KEY, PERSONAL_MOVIES_DB_API_KEY)
                ...
                .appendQueryParameter(SORTING_PAR_KEY, QUERY_SORTING_AVERAGE)
                ...
                .appendQueryParameter(VOTE_AVERAGE_FROM_PAR_KEY, QUERY_VOTE_AVERAGE);
